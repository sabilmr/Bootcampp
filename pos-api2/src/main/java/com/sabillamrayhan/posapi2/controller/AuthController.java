...
import com.sabillamrayhan.posapi2.model.*;
...
public class AuthController {
    ...
    public ResponseEntity<Response> authenticate(@RequestBody AuthRequest request){
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new Response(400,"FAILED","User Not found"));
    }
    ...
    @GetMapping("/profile")
    public ResponseEntity<Response> getProfile(HttpServletRequest request, HttpServletResponse response){
